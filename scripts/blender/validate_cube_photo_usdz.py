...
for folder,name,size,albedo in [('cube-210030','cube-v9',[.8,.71,.8],'v9-original-photo-atlas.jpg')]:
...
(root/'assets/cube-210030/qa/v9/usdz-validation.json').write_text(json.dumps(reports,indent=2)+'\n');print(json.dumps(reports))
