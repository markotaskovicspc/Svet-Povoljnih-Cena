...
root=Path(__file__).resolve().parents[2];base=root/'assets/cube-210030';public=root/'public/models/cube-210030'
p=public/'cube-v5.usdz'
...
assert all(abs(a-b)<.001 for a,b in zip(size,[.8,.71,.8]))
assert abs(low[1])<.001 and len(textures)>=3
