...
for folder,name,version,tag in [('cube-210030','cube','v9','source')]:
 for fmt in ['glb','usdz']:
  base=root/'assets'/folder
  bpy.ops.wm.open_mainfile(filepath=str(base/(name+'-photo-fidelity.blend')))
  ...
  bpy.context.scene.render.filepath=str(base/'renders'/(version+'-photo-'+fmt+'-roundtrip.png'))
