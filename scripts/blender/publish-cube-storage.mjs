...
const assets = [
  ['glbUrl', 'cube-v7.glb', types[0]],
  ['usdzUrl', 'cube-v7.usdz', types[1]],
  ['posterUrl', 'poster-v7.webp', types[2]],
];
...
await mkdir('assets/cube-210030/qa/realism-storage', { recursive: true });
await writeFile('assets/cube-210030/qa/realism-storage/upload.json', JSON.stringify({ bucket, public: true, project: new URL(url).hostname, verified }, null, 2) + '\n');
