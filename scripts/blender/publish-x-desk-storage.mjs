...
const assets = [
  ['glbUrl', 'x-desk-v3.glb', types[0]],
  ['usdzUrl', 'x-desk-v3.usdz', types[1]],
  ['posterUrl', 'poster-v3.webp', types[2]],
];
...
await mkdir('assets/x-desk-210027/qa/realism-storage', { recursive: true });
await writeFile('assets/x-desk-210027/qa/realism-storage/upload.json', JSON.stringify({ bucket, public: true, project: new URL(url).hostname, verified }, null, 2) + '\n');
