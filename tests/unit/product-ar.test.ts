...
describe("product AR", () => {
  it("only enables registered products with their own dimensions and files", () => {
    ...
    expect(getProductArAsset("100010-9ce68e")?.glbUrl).toContain("x-desk-210027/x-desk-v1.glb");
    expect(getProductArAsset("100010-9ce68e")?.usdzUrl).toContain("x-desk-210027/x-desk-v1.usdz");
