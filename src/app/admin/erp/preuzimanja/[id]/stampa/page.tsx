  ...
  return (
    <main className="mx-auto max-w-[1200px] space-y-8 bg-white p-6 text-black print:max-w-none print:p-0">
      <div className="flex flex-wrap items-center justify-between gap-3 print:hidden">
        ...
        <PrintPageButton label="Štampaj listu i interne etikete" />
      </div>
      ...
      <section>
        <header className="mb-5 print:hidden">
          <h2 className="text-2xl font-bold">Kurirske adresnice za ponovno štampanje</h2>
          {shipments.length ? (
                ...
                return (
                  <li key={shipment.id}>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex rounded-lg border border-black px-3 py-2 text-sm"
                    >
                      {order?.number ?? shipment.orderId} · {shipment.trackingNo ?? "adresnica"}
                    </a>
                  </li>
                );
              })}
            ...
            <p className="mt-2 text-sm">Kurirske adresnice još nisu kreirane. Interne etikete ispod mogu odmah da se štampaju.</p>
          )}
        </header>
            ...
            >
              <div>
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="text-xs font-bold uppercase">{providerLabel(batch.provider)}</p>
