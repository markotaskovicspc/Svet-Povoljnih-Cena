    ...
    async (actorId, actionData: FormData) => {
      ...
      if (!result.ok) {
        const errors: Record<typeof result.reason, string> = {
          ...
          ORDER_NOT_DELIVERED: "Reklamacija je dozvoljena samo za isporučenu porudžbinu.",
          ITEM_NOT_FOUND: "Stavka više nije pronađena u porudžbini.",
          UNAUTHORIZED: "Nemate pravo da unesete ovu reklamaciju.",
          INVALID_PHOTO: "Priložena fotografija nije ispravna.",
          QUANTITY_EXCEEDED: "Količina prelazi preostalu reklamabilnu količinu.",
        };
