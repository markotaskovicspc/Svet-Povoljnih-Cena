    ...
    >
      {benefits.map(({ label, lines, Icon }) => (
        <li
          key={label}
          aria-label={label}
          className="flex aspect-[2.82/1] items-center gap-[clamp(0.25rem,0.65vw,0.75rem)] rounded-[clamp(0.5rem,1vw,1rem)] border border-ink-900 bg-white px-[clamp(0.35rem,0.8vw,0.85rem)] text-ink-900"
        >
          <Icon
            ...
            aria-hidden
          />
          <span className="flex min-w-0 flex-1 flex-col items-center text-center text-[clamp(0.45rem,1vw,0.9rem)] leading-[1.15] font-semibold tracking-[0.02em] uppercase">
            <span>{lines[0]}</span>
