...
export function getIntegrationReadiness(
  ...
  return [
    ...
    integration(env, {
      ...
      description: "Slanje porudžbina, potvrda, računa i newsletter poruka.",
      requirements: [
        equals("EMAIL_PROVIDER", "ses"),
        presentOneOf("SES_REGION", "AWS_REGION"),
        presentOneOf("AWS_ROLE_ARN", "AWS_ACCESS_KEY_ID"),
        present("EMAIL_FROM"),
        present("EMAIL_MARKETING_FROM"),
    ...
    integration(env, {
      ...
      requirements: [
        ...
        present("MYGLS_SENDER_IDENTITY_CARD_NUMBER"),
        present("MYGLS_SENDER_IDENTITY_TYPE"),
        present("MYGLS_PICKUP_NAME"),
        present("MYGLS_PICKUP_STREET"),
        present("MYGLS_PICKUP_HOUSE_NUMBER"),
