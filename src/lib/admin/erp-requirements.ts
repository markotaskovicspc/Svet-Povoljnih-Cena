...
const ERP_REQUIREMENT_ROWS: readonly Omit<ErpRequirement, "evidence">[] = [
  ...
  { id: 18, section: "Pregled porudžbina", route: "/admin/erp/prodajni-nalozi", status: "implemented", acceptance: "SALE-01", note: "Jedinstven WEB, ANANAS, MP, VP i INO pregled sa datumom porudžbine i fiskalizacije, po jednim redom po šifri, dokumentnim statusima i detaljem cele porudžbine." },
  { id: 19, section: "Nova porudžbina", route: "/admin/erp/prodajni-nalozi/nova", status: "implemented", acceptance: "SALE-02", note: "Transakcioni MP/VP/INO unos sa zasebnom numeracijom, snimkom matičnih podataka, cenovnikom i DC/dobavljač rezervacijama." },
