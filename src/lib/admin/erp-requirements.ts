...
export const ERP_REQUIREMENTS: readonly ErpRequirement[] = [
  ...
  { id: 23, section: "Otpremnice", route: "/admin/erp/otpremnice", status: "implemented", acceptance: "LOG-01", note: "Pregled, kreiranje, brisanje nacrta, knjiženje lagera, PDF/XLSX i slanje na eOtpremnicu." },
