export const LOYALTY_CONSENT_VERSION = "spc-loyalty-2026-09-24-v2";
export const LOYALTY_CONSENT_SECTIONS = [
  {
    title: "Pristupanje programu",
    body: "Želim da pristupim loyalty programu Svet Povoljnih Cena i dobrovoljno dajem pristanak za obradu podataka opisanu u ovoj izjavi. Članstvo se aktivira potvrdom moje mejl adrese, bez kreiranja korisničkog naloga, izdavanja broja kartice ili fizičke kartice. Kupovinu mogu obaviti i bez pristupanja programu, po cenama i uslovima koji važe za kupce bez loyalty pogodnosti.",
  },
  {
  ...
  },
  {
    ...
    body: "Za članstvo se obrađuju moja mejl adresa, podatak o njenoj potvrdi, vreme davanja pristanka i verzija prihvaćene izjave. Mejl adresa povezuje se sa podacima o mojim porudžbinama i iskorišćenim pogodnostima radi provere uslova za popuste, uključujući pogodnost za prvu kupovinu. Ovi podaci služe za potvrdu i evidenciju članstva, obračun pogodnosti i komunikaciju neophodnu za članstvo. Ime, telefon, adresa i ostali podaci koje unesem pri kupovini obrađuju se za realizaciju porudžbine prema Politici privatnosti; samo pristupanje programu ne zahteva njihov ponovni unos.",
  },
  {
    title: "Loyalty pogodnosti",
    body: "Nakon potvrde mejla ostvarujem 30% loyalty popusta na artikle koji nisu na aktivnoj akciji. Ako ispunjavam uslov za prvu kupovinu, ostvarujem i dodatnih 15% na već obračunatu vrednost artikala, bez dostave. Pravo na pogodnost za prvu kupovinu proverava se prema istoriji porudžbina povezanih sa mojom mejl adresom: pogodnost je iskorišćena kada postoji izdat fiskalni račun za prodaju. Konačne cene i popusti prikazuju se pre potvrde porudžbine.",
  },
  {
    title: "Pristup podacima i čuvanje",
    body: "Podacima pristupaju ovlašćena lica rukovaoca i pružaoci tehničkih usluga potrebnih za rad programa i slanje potvrde mejla, u obimu potrebnom za te poslove i uz obavezu zaštite podataka. Podaci se mogu dostaviti nadležnim organima kada za to postoji zakonska obaveza. Podaci o članstvu čuvaju se dok je članstvo aktivno, odnosno do povlačenja pristanka. Nakon toga se brišu ili anonimizuju, osim podataka koje je potrebno zadržati po drugom pravnom osnovu, uz ograničenje na odgovarajuću svrhu i potreban rok. Dokumentacija o porudžbinama i fiskalnim računima čuva se odvojeno, prema rokovima navedenim u Politici privatnosti. Za pamćenje potvrđenog članstva u pregledaču koristi se nužni kolačić koji traje do 30 dana.",
  },
  {
